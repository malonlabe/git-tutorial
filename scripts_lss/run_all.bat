@echo off
@echo .........................................................................
@echo run D:\dev\Genie_test_all\src\GEngine\Target\Win32\GenieD.exe
...
rem GasModGenie:
start "GasModGenie" /D GasModGenie %TARGET_DIR%\GasModGenie\GasModGenie.exe

rem GasModTester:
start "GasModTester" /D GasModGenie %TARGET_DIR%\GasModGenie\GasModTester.exe

rem Alarm manager:
start "Alarm manager" /D AlarmManager %TARGET_DIR%/AlarmManager/AlarmManagerGenie.exe

rem Genie:
start %TARGET_DIR%/%APP_TO_RUN% %MODE%
